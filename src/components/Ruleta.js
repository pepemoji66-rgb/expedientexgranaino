...
const Ruleta = () => {
    ...
    return (
        <div className="ruleta-container">
            ...
            {/* SECCIÓN APOYO KO-FI */}
            <div style={{ maxWidth: '600px', margin: '30px auto', padding: '22px 24px', background: 'rgba(45,90,67,0.08)', border: '1px solid rgba(45,90,67,0.2)', borderRadius: '8px', textAlign: 'center' }}>
