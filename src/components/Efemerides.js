...
const Efemerides = () => {
    ...
    const fechaHoy = new Date().toLocaleDateString(language === 'en' ? 'en-US' : 'es-ES', { day: 'numeric', month: 'long' });
        ...
        <div className="efemerides-widget">
            <div className="efemerides-header">
                <div className="efemerides-badge">
                    ...
                    <span className="efemerides-label">{t('efemeridesTitle')}</span>
                </div>
            ...
            <div className="efemerides-body">
                ...
                >
                    {expandido ? t('efemeridesCollapse') : t('efemeridesExpand')}
                </button>
            </div>

            <div className="efemerides-footer">
                <div className="efemerides-scanner-line"></div>
                <small>{t('efemeridesFooter')}</small>
            </div>
        </div>
    );
};
